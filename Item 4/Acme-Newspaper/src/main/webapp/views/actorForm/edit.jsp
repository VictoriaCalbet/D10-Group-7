...
<form:form action="${requestURI}" modelAttribute="actorForm">
	...
	<acme:textarea code="actorForm.postalAddresses" path="postalAddresses"/>
	<acme:textarea code="actorForm.phoneNumbers" path="phoneNumbers"/>
	<acme:textarea code="actorForm.emailAddresses" path="emailAddresses"/>
